...
os reiniciam em caso de falhas. [cite:@armstrong2013 p.398 chapter.23 part.23.5]
#+end_quote
...
+ O provisionamento da infra inicial é feito com [[https://opentofu.org/][Open Tofu]].
+ Toda a configuração da máquina no EC2 é feita com Nix. O deploy da
  configuração em Nix possui 2 fases:
...
** Uma bomba atômica a cada reboot
